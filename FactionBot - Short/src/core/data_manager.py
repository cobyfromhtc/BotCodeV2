# -*- coding: utf-8 -*-
"""SQLite data manager — persistent storage layer.

Extracted unchanged from the former single-file Bot.py during the SaaS
restructure. Read-through caches + write-behind message buffer mean hot
paths never touch the disk synchronously (see docs/PERFORMANCE.md).
"""
...
# in read-through caches below. Must be module-level so pickle/other modules
# never see it.
_CACHE_MISS = object()
